...
"On gtm-api (MCP connector at https://mcp.gtm-api.com/mcp, or REST at app.gtm-api.com with my key): register a webhook for my endpoint URL with the events I name, list the available event types first so I can pick, then watch the delivery log and show me the first delivery's status and response code."
</Tip>
