...
GTM API ships a managed MCP server at `https://mcp.gtm-api.com/mcp`. It exposes 279 typed tools across 18 toolsets, so Claude, Cursor, ChatGPT or a custom agent runtime can search, connect, message and enrich on a LinkedIn account you own.
