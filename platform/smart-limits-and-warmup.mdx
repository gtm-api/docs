...
<Frame caption="The Smart Limits tab of the account drawer: the warmup score with its six signals, incident logs, and the per-action caps below.">
  <img src="/images/platform/account-drawer-smart-limits.png" alt="Smart Limits tab showing the warmup percentage, six health signals and per-action daily caps" />
</Frame>
