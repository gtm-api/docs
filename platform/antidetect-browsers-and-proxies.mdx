...
[Sync windows and auto-suspend](/platform/sync-windows-and-auto-suspend).
</Note>
...
<Frame caption="The Browser tab of the account drawer: browser state on the left, proxy health on the right, the event log below.">
  <img src="/images/platform/account-drawer-browser.png" alt="Account drawer Browser tab showing the antidetect browser block, proxy block and browser event log" />
</Frame>
...
- [Connect a LinkedIn account](/guides/connect-a-linkedin-account)
- [Sync windows and auto-suspend](/platform/sync-windows-and-auto-suspend)
