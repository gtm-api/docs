...
<CardGroup cols={2}>
  ...
  <Card title="Knowledge base" href="/kb">
    How the platform works, for the person running outreach: accounts and browsers, safety and pacing, finding and enriching datafinding and enriching data. With screenshots.
  </Card>
