...
| ID and Teams | `https://app.gtm-api.com/id/v4` | Users, teams, API keys, OAuth, billing, subscriptions, the credit ledger, notifications |
...
<CardGroup cols={2}>
  ...
  <Card title="Knowledge base" href="/kb">
    ...
    browsers, safety and pacing, data and credits. With screenshots.
  </Card>
